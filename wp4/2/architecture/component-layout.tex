...
\Cref{fig:esdm layout logical view} illustrates the embedding of the layout component into the broader ESDM architecture.
...
\Cref{fig:esdm layout choose backend} shows a simplified example of how the decision process for a data centre with three storage systems may appear.
...
% Unaddressed: When to release allocated memory?
